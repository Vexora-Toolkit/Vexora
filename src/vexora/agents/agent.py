...
from vexora.agents.names import AGENT_NAMES
...
from vexora.utilities.tools import wrap_tool_errors
from vexora.utilities.types import issubclass_safe
...
if TYPE_CHECKING:
    ...
    from vexora.engine.events import Event
...
class Agent(Actor):
    ...
    def get_model(self) -> Model | KnownModelName:
        return self.model or vexora.defaults.model
    ...
    def get_model_settings(self) -> ModelSettings:
        ...
        if vexora.settings.agent_temperature is not None:
            defaults["temperature"] = vexora.settings.agent_temperature
...
def get_agentlet(
    ...
    agentlet = pydantic_ai.Agent[Any, result_type](  # type: ignore
        ...
        retries=vexora.settings.agent_retries,
    )
