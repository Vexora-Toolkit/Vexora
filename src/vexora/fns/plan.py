...
objectives and must produce at least one vexora Task that, when completed, will
...
async def plan_async(
    ...
    Returns:
        A list of vexora Tasks that will allow you or other AI agents to achieve the objective.

    Examples:
        >>> tasks = await vexora.plan_async("Create a new blog post about the latest AI trends.")
    ...
    task = vexora.Task[list[PlanTask]](
        name="Planning Task",
        instructions=prompt,
...
def plan(
    ...
    """
    Generate a series of vexora Tasks that will allow you or other AI agents to achieve a goal.
    ...
    Examples:
        >>> tasks = vexora.plan("Create a new blog post about the latest AI trends.")
